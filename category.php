...
<header class="archive-header">
	<div class="container">
		<span class="label archive-header__kicker"><?php echo esc_html($is_en ? 'Category' : '分类'); ?></span>
...
<section class="section" style="padding-top:0;">
	<div class="container">
		...
		<?php else : ?>
			<p class="faq-empty"><?php echo esc_html($is_en ? 'No posts in this category.' : '该分类下暂无内容。'); ?></p>
		<?php endif; ?>
	</div>
</section>
