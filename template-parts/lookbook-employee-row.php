...
<article class="lookbook-row <?php echo ( 0 === $index % 2 ) ? 'lookbook-row--reverse' : ''; ?>" data-lb-reveal>
	...
	<div class="lookbook-row__copy">
		<p class="lookbook-row__label"><span class="lookbook-row__num"><?php echo esc_html( str_pad( (string) $index, 2, '0', STR_PAD_LEFT ) ); ?></span><span class="lookbook-row__slash" aria-hidden="true"> / </span><span class="lookbook-row__kicker"><?php echo esc_html( $kicker ); ?></span></p>
		<h2 class="lookbook-row__title"><?php echo esc_html( $title ); ?></h2>
		<p class="lookbook-row__desc"><?php echo esc_html( $desc ); ?></p>
		<a class="lookbook-btn lookbook-btn--<?php echo esc_attr( $style ); ?>" href="<?php echo esc_url( $url ); ?>"><?php echo esc_html( $btn ); ?></a>
	</div>
</article>
