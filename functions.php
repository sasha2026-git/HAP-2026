...
/* -------------------------------------------------------------------------
 * 10.5 ACF 字段组 — 首页 v2（新设计稿）
 *     匹配 front-page.php 模板结构：Hero / AI数字员工矩阵 / 品牌宣言 / 案例 / FAQ / 定制咨询
 * ---------------------------------------------------------------------- */
add_action('acf/init', function () {
    if (!function_exists('acf_add_local_field_group')) {
        return;
    ...
    /* ---- 辅助：zh/en 双 Tab ---- */
    $hireai_v2_make_group = function ($key, $title, $fields, $location) {
        $out = [];
        $out[] = ['key' => $key . '_tab_zh', 'label' => '中文内容', 'type' => 'tab'];
    ...
    /* ---- 1. Hero ---- */
    acf_add_local_field_group($hireai_v2_make_group('group_hp_hero', '首页 v2 — Hero 区域', [
        ['name' => 'hp_hero_kicker', 'label' => '眉题', 'type' => 'text', 'zh' => 'PRESTIGE DIGITAL LABOR', 'en' => 'PRESTIGE DIGITAL LABOR'],
        ['name' => 'hp_hero_title', 'label' => '大标题（换行分隔两行）', 'type' => 'textarea', 'zh' => "HireAIPeople\n聘用AI数字员工", 'en' => "HireAIPeople\n聘用AI数字员工", 'extra' => ['rows' => 2]],
        ['name' => 'hp_hero_subtitle', 'label' => '副标题（换行分隔两行）', 'type' => 'textarea', 'zh' => "Neural Craftsmanship &amp; Digital Excellence.\n将艺术灵魂注入神经算法，打造具备卓越品味的数字生产力。", 'en' => "Neural Craftsmanship &amp; Digital Excellence.\n将艺术灵魂注入神经算法，打造具备卓越品味的数字生产力。", 'extra' => ['rows' => 3]],
        ['name' => 'hp_hero_image', 'label' => '背景图', 'type' => 'image', 'zh' => '', 'en' => '', 'extra' => ['return_format' => 'array']],
        ['name' => 'hp_hero_cta_primary', 'label' => '主按钮', 'type' => 'link', 'zh' => ['url' => '/contact/', 'title' => '立即咨询'], 'en' => ['url' => '/contact/', 'title' => 'Contact Us']],
        ['name' => 'hp_hero_cta_secondary', 'label' => '次按钮', 'type' => 'link', 'zh' => ['url' => '/cases-insights/', 'title' => '查看案例'], 'en' => ['url' => '/cases-insights/', 'title' => 'View Cases']],
    ], [
        [['param' => 'page_template', 'operator' => '==', 'value' => 'front-page.php']],
        [['param' => 'front_page', 'operator' => '==', 'value' => '1']],
    ]));

    /* ---- 2. AI 数字员工矩阵 + 品牌宣言 + FAQ 标题 ---- */
    acf_add_local_field_group($hireai_v2_make_group('group_hp_modules_v2', '首页 v2 — 模块标题', [
        ['name' => 'hp_matrix_kicker', 'label' => '矩阵 · 眉题', 'type' => 'text', 'zh' => 'THE DIGITAL ATELIER', 'en' => 'THE DIGITAL ATELIER'],
        ['name' => 'hp_matrix_title', 'label' => '矩阵 · 标题', 'type' => 'textarea', 'zh' => 'AI数字员工矩阵', 'en' => 'AI Digital Employee Matrix', 'extra' => ['rows' => 1]],

        ['name' => 'hp_brand_title', 'label' => '品牌宣言 · 标题', 'type' => 'textarea', 'zh' => 'Begin Your Bespoke Journey', 'en' => 'Begin Your Bespoke Journey', 'extra' => ['rows' => 1]],
        ['name' => 'hp_brand_subtitle', 'label' => '品牌宣言 · 副标题', 'type' => 'text', 'zh' => '探索专属于您的AI数字艺术', 'en' => '探索专属于您的AI数字艺术'],

        ['name' => 'hp_cases_kicker', 'label' => '案例 · 眉题', 'type' => 'text', 'zh' => 'THE MASTERPIECES', 'en' => 'THE MASTERPIECES'],
        ['name' => 'hp_cases_title', 'label' => '案例 · 标题', 'type' => 'textarea', 'zh' => '卓越案例展示', 'en' => 'Featured Cases', 'extra' => ['rows' => 1]],
        ['name' => 'hp_cases_cta', 'label' => '案例 · 按钮', 'type' => 'link', 'zh' => ['url' => '/cases-insights/', 'title' => '探索全部案例'], 'en' => ['url' => '/cases-insights/', 'title' => 'Explore Full Gallery']],

        ['name' => 'hp_faq_kicker', 'label' => 'FAQ · 眉题', 'type' => 'text', 'zh' => 'THE INTELLIGENCE LIBRARY', 'en' => 'THE INTELLIGENCE LIBRARY'],
        ['name' => 'hp_faq_title', 'label' => 'FAQ · 标题', 'type' => 'textarea', 'zh' => '常见问题解答', 'en' => 'FAQ', 'extra' => ['rows' => 1]],
    ], [
        [['param' => 'page_template', 'operator' => '==', 'value' => 'front-page.php']],
        [['param' => 'front_page', 'operator' => '==', 'value' => '1']],
    ]));
    ...
    /* ---- 2b. AI 数字员工卡片（3 张） ---- */
    acf_add_local_field_group($hireai_v2_make_group('group_hp_emp_cards', '首页 v2 — AI数字员工卡片', [
        ['name' => 'hp_emp1_kicker', 'label' => '卡片1 · 分类标签', 'type' => 'text', 'zh' => 'Public Relations', 'en' => 'Public Relations'],
        ['name' => 'hp_emp1_title', 'label' => '卡片1 · 标题', 'type' => 'text', 'zh' => '公关审核', 'en' => 'PR Audit'],
        ['name' => 'hp_emp1_desc', 'label' => '卡片1 · 描述', 'type' => 'textarea', 'zh' => '由AI驱动的舆情洞察与文案合规专家，确保品牌在复杂的社交媒体环境中保持尊贵与体面的发声。', 'en' => 'AI-driven media insight and copy compliance specialist, ensuring the brand maintains a dignified and tasteful voice in complex social media environments.', 'extra' => ['rows' => 3]],
        ['name' => 'hp_emp1_image', 'label' => '卡片1 · 图片', 'type' => 'image', 'zh' => '', 'en' => '', 'extra' => ['return_format' => 'array']],

        ['name' => 'hp_emp2_kicker', 'label' => '卡片2 · 分类标签', 'type' => 'text', 'zh' => 'Branding Strategy', 'en' => 'Branding Strategy'],
        ['name' => 'hp_emp2_title', 'label' => '卡片2 · 标题', 'type' => 'text', 'zh' => 'IP联名营销', 'en' => 'IP Co-branding'],
        ['name' => 'hp_emp2_desc', 'label' => '卡片2 · 描述', 'type' => 'textarea', 'zh' => '策划跨次元的创意联名，利用AI生成无限可能的视觉语言，连接虚拟与现实的顶级商业价值。', 'en' => 'Orchestrating cross-dimensional creative collaborations, using AI to generate infinite visual languages that connect virtual and real top-tier commercial value.', 'extra' => ['rows' => 3]],
        ['name' => 'hp_emp2_image', 'label' => '卡片2 · 图片', 'type' => 'image', 'zh' => '', 'en' => '', 'extra' => ['return_format' => 'array']],

        ['name' => 'hp_emp3_kicker', 'label' => '卡片3 · 分类标签', 'type' => 'text', 'zh' => 'E-commerce Aesthetics', 'en' => 'E-commerce Aesthetics'],
        ['name' => 'hp_emp3_title', 'label' => '卡片3 · 标题', 'type' => 'text', 'zh' => '电商视觉设计', 'en' => 'E-commerce Design'],
        ['name' => 'hp_emp3_desc', 'label' => '卡片3 · 描述', 'type' => 'textarea', 'zh' => '为奢品电商定制的高级视觉，秒级生成具备Dior质感的产品构图，重塑线上购物的感官体验。', 'en' => 'Premium visuals tailored for luxury e-commerce, generating Dior-quality product compositions in seconds, reshaping the sensory experience of online shopping.', 'extra' => ['rows' => 3]],
        ['name' => 'hp_emp3_image', 'label' => '卡片3 · 图片', 'type' => 'image', 'zh' => '', 'en' => '', 'extra' => ['return_format' => 'array']],
    ], [
        [['param' => 'page_template', 'operator' => '==', 'value' => 'front-page.php']],
        [['param' => 'front_page', 'operator' => '==', 'value' => '1']],
    ]));
    ...
    /* ---- 2c. 案例区域（1 大 + 2 小） ---- */
    acf_add_local_field_group($hireai_v2_make_group('group_hp_cases_v2', '首页 v2 — 案例展示', [
        ['name' => 'hp_case_major_kicker', 'label' => '主案例 · 分类', 'type' => 'text', 'zh' => 'Luxury Real Estate', 'en' => 'Luxury Real Estate'],
        ['name' => 'hp_case_major_title', 'label' => '主案例 · 标题', 'type' => 'text', 'zh' => '顶级豪宅AI虚拟策展项目', 'en' => 'Luxury Villa AI Virtual Curation'],
        ['name' => 'hp_case_major_desc', 'label' => '主案例 · 描述', 'type' => 'textarea', 'zh' => '利用AI数字孪生技术与视觉渲染，为全球高净值人群打造沉浸式的虚拟看房体验。', 'en' => 'Using AI digital twin technology and visual rendering to create immersive virtual house-touring experiences for global high-net-worth individuals.', 'extra' => ['rows' => 3]],
        ['name' => 'hp_case_major_image', 'label' => '主案例 · 图片', 'type' => 'image', 'zh' => '', 'en' => '', 'extra' => ['return_format' => 'array']],

        ['name' => 'hp_case_s1_kicker', 'label' => '副案例1 · 分类', 'type' => 'text', 'zh' => 'Haute Couture', 'en' => 'Haute Couture'],
        ['name' => 'hp_case_s1_title', 'label' => '副案例1 · 标题', 'type' => 'text', 'zh' => '高级定制AI面料纹样', 'en' => 'AI Couture Fabric Patterns'],
        ['name' => 'hp_case_s1_desc', 'label' => '副案例1 · 描述', 'type' => 'textarea', 'zh' => '通过GAN生成对抗网络，为巴黎时装周提供灵感触点，复刻手工刺绣的精密纹理。', 'en' => 'Through GAN generative adversarial networks, providing inspiration for Paris Fashion Week, replicating the intricate textures of hand-embroidery.', 'extra' => ['rows' => 3]],
        ['name' => 'hp_case_s1_image', 'label' => '副案例1 · 图片', 'type' => 'image', 'zh' => '', 'en' => '', 'extra' => ['return_format' => 'array']],

        ['name' => 'hp_case_s2_kicker', 'label' => '副案例2 · 分类', 'type' => 'text', 'zh' => 'Bvlgari Style Marketing', 'en' => 'Bvlgari Style Marketing'],
        ['name' => 'hp_case_s2_title', 'label' => '副案例2 · 标题', 'type' => 'text', 'zh' => '品牌社媒视觉重塑', 'en' => 'Brand Social Media Visual Refresh'],
        ['name' => 'hp_case_s2_desc', 'label' => '副案例2 · 描述', 'type' => 'textarea', 'zh' => '将传统奢侈品调性与前卫数字美学融合，打造更具社交穿透力的视觉符号。', 'en' => 'Fusing traditional luxury aesthetics with avant-garde digital beauty to create visually compelling symbols with greater social penetration.', 'extra' => ['rows' => 3]],
    ], [
        [['param' => 'page_template', 'operator' => '==', 'value' => 'front-page.php']],
        [['param' => 'front_page', 'operator' => '==', 'value' => '1']],
    ]));
        ...
        /* ---- 3. 定制咨询区域 ---- */
    acf_add_local_field_group($hireai_v2_make_group('group_hp_contact_v2', '首页 v2 — 定制咨询', [
        ['name' => 'hp_contact_kicker', 'label' => '眉题', 'type' => 'text', 'zh' => 'THE PRIVATE CONCIERGE', 'en' => 'THE PRIVATE CONCIERGE'],
        ['name' => 'hp_contact_title', 'label' => '标题', 'type' => 'textarea', 'zh' => '定制您的AI数字生产力', 'en' => 'Customize Your AI Digital Productivity', 'extra' => ['rows' => 1]],
        ['name' => 'hp_contact_desc', 'label' => '描述', 'type' => 'textarea', 'zh' => '无论是追求极致的品牌形象，还是提升业务效率，我们的定制专家将为您量身打造专属方案。', 'en' => 'Whether pursuing the ultimate brand image or enhancing business efficiency, our customization experts will craft a tailored solution for you.', 'extra' => ['rows' => 3]],
        ['name' => 'hp_contact_email', 'label' => '联系邮箱', 'type' => 'text', 'zh' => 'concierge@hireaipeople.com', 'en' => 'concierge@hireaipeople.com'],
        ['name' => 'hp_contact_lark_label', 'label' => '飞书标签', 'type' => 'text', 'zh' => '飞书咨询', 'en' => 'Lark Concierge'],
        ['name' => 'hp_contact_lark_sublabel', 'label' => '飞书副标签', 'type' => 'text', 'zh' => 'Lark Concierge', 'en' => 'Lark Concierge'],
        ['name' => 'hp_contact_wechat_label', 'label' => '微信标签', 'type' => 'text', 'zh' => '微信咨询', 'en' => 'WeChat Support'],
        ['name' => 'hp_contact_wechat_sublabel', 'label' => '微信副标签', 'type' => 'text', 'zh' => 'WeChat Support', 'en' => 'WeChat Support'],
        ['name' => 'hp_contact_qr_image', 'label' => '二维码图片', 'type' => 'image', 'zh' => '', 'en' => '', 'extra' => ['return_format' => 'array']],
        ['name' => 'hp_form_name_label', 'label' => '表单 · 姓名', 'type' => 'text', 'zh' => '姓名 / Name', 'en' => 'Name'],
        ['name' => 'hp_form_budget_label', 'label' => '表单 · 预算', 'type' => 'text', 'zh' => '预算 / Budget', 'en' => 'Budget'],
        ['name' => 'hp_form_contact_label', 'label' => '表单 · 联系方式', 'type' => 'text', 'zh' => '联系方式 / Contact', 'en' => 'Contact'],
        ['name' => 'hp_form_needs_label', 'label' => '表单 · 需求', 'type' => 'text', 'zh' => '您的需求 / Needs', 'en' => 'Your Needs'],
        ['name' => 'hp_form_submit_label', 'label' => '表单 · 提交按钮', 'type' => 'text', 'zh' => '提交需求', 'en' => 'Submit Inquiry'],
    ], [
        [['param' => 'page_template', 'operator' => '==', 'value' => 'front-page.php']],
        [['param' => 'front_page', 'operator' => '==', 'value' => '1']],
    ]));
