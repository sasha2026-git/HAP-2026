...
<div class="lookbook-page">
	...
	<section class="lookbook-hero">
		<div class="lookbook-container lookbook-hero__inner">
			<p class="lookbook-hero__kicker" data-lb-reveal><?php echo esc_html( $hero_kicker ); ?></p>
			<h1 class="lookbook-hero__title" data-lb-reveal><?php echo esc_html( $hero_title ); ?></h1>
			<p class="lookbook-hero__subtitle" data-lb-reveal><?php echo esc_html( $hero_sub ); ?></p>
			<div class="lookbook-hero__divider" data-lb-reveal aria-hidden="true"></div>
		</div>
	</section>
	...
	<section class="lookbook-list">
		<div class="lookbook-container">
			...
			<?php if ( $lb_query->max_num_pages > 1 ) : ?>
				<nav class="lookbook-pagination" aria-label="<?php echo esc_attr( $is_zh ? '分页' : 'Pagination' ); ?>">
					<?php
	...
	<!-- ================= CTA 带 ================= -->
	<section class="lookbook-cta">
		<div class="lookbook-container lookbook-cta__inner">
			<h2 class="lookbook-cta__heading" data-lb-reveal><?php echo esc_html( $cta_heading ); ?></h2>
			<p class="lookbook-cta__sub" data-lb-reveal><?php echo esc_html( $cta_sub ); ?></p>
			<div class="lookbook-cta__actions" data-lb-reveal>
				<a class="lookbook-btn lookbook-btn--filled" href="<?php echo esc_url( $cta_url ); ?>"><?php echo esc_html( $cta_btn ); ?></a>
				<a class="lookbook-cta__ghost" href="<?php echo esc_url( $cta_url ); ?>"><?php echo esc_html( $cta_link_txt ); ?> <span aria-hidden="true">&rarr;</span></a>
			</div>
		</div>
	</section>
